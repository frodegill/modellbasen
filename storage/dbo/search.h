...
public:
	bool AddIntegerSearchInstance(Poco::UInt32 tag_id, //integer, location
	                              Tag::TagDataType insert_datatype, Tag::TagDataType query_datatype, Poco::UInt32 intvalue);

	bool AddStringSearchInstance(Poco::UInt32 tag_id, //string
	...
	bool AddIntegerIntegerSearchInstance(Poco::UInt32 tag_id, //height_range, day_range, age_range, distance
